...
import wiki.tree.security.google.GoogleAccessTokenConverter;
import wiki.tree.security.google.GoogleTokenService;
import wiki.tree.security.google.MapClientTokenServices;
        ...
        http
            ...
            .and()
                ...
                .authenticationEntryPoint(
                        new LoginUrlAuthenticationEntryPoint(env.getProperty("security-oauth.google.loginUrl")))
            .and()
                .logout()
            .and()
                .anonymous()
